...
def create_hmc_comparison_plot(results_df, output_dir):
    ...
    if timing_data:
        ...
        for idx, n_samples in enumerate(n_samples_list):
            ...
            # chain_data = chain_data[chain_data['framework'] != 'handcoded_tfp']
            ...
            for i, (_, row) in enumerate(chain_data.iterrows()):
                ...
                if time_ms > 0 and framework != 'handcoded_tfp':
    ...
    framework_order = ['genjax', 'handcoded_tfp', 'numpyro', 'pyro', 'genjl', 'handcoded_torch']
...
def create_plots(df, output_dir):
    ...
    colors = {
        ...
        'handcoded_tfp': 'gold',         # Same as faircoin (handcoded baseline)
    ...
    if timing_data:
        ...
        # Create grouped bar chart (exclude handcoded_tfp as it's the baseline)
        ...
        for idx, n_particles in enumerate(n_particles_list):
            ...
            # Don't filter out handcoded baseline - we'll show it as a bar
            # particle_data = particle_data[particle_data['framework'] != 'handcoded_tfp']
            ...
            for i, (_, row) in enumerate(particle_data.iterrows()):
                ...
                # Add scale factor label on bar (skip for handcoded baseline itself)
                if time_ms > 0 and n_particles in baseline_times and framework != 'handcoded_tfp':
    ...
    framework_order = ['genjax', 'handcoded_tfp', 'numpyro', 'pyro', 'genjl_dynamic', 'handcoded_torch']
...
def main():
    ...
    parser.add_argument("--frameworks", nargs="+",
                        default=["genjax", "numpyro", "handcoded_tfp", "pyro", "genjl", "genjl_dynamic", "handcoded_torch"],
