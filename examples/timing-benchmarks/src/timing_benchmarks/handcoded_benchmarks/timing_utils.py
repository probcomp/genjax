"""Timing utilities for handcoded benchmarks - consistent with curvefit benchmarks."""
...
def timing(
    ...
    Args:
        ...
        auto_sync: Whether to automatically synchronize JAX operations
    ...
    for i in range(repeats):
        ...
        for j in range(inner_repeats):
            ...
            result = fn()
            if auto_sync and hasattr(result, 'block_until_ready'):
