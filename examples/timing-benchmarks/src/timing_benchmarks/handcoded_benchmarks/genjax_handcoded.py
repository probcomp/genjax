"""GenJAX GMM benchmarks for handcoded comparison."""
...
from .gmm_benchmarks import time_genjax_gmm


def main():
    parser = argparse.ArgumentParser(description="Run GenJAX GMM benchmarks")
    ...
    parser.add_argument(
        "--output-dir", type=str, default="data/genjax_handcoded",
    ...
    # Run GMM benchmarks
    print("Running GenJAX GMM benchmarks...")
    gmm_results = []
    for n_data in args.data_sizes:
        print(f"  Data size: {n_data:,}")
        result = time_genjax_gmm(n_data, args.gmm_steps, args.repeats)
