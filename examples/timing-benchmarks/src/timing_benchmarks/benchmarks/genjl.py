...
def gen_polynomial_is_timing(dataset, n_particles, repeats=100, setup_julia=False):
...
def gen_polynomial_hmc_timing(dataset, n_samples, n_warmup=500, repeats=100, setup_julia=False):
...
if __name__ == "__main__":
    ...
    if args.method in ["is", "all"]:
        ...
        for n_particles in args.n_particles:
            ...
            result = gen_polynomial_is_timing(
    ...
    if args.method in ["hmc", "all"]:
        ...
        result = gen_polynomial_hmc_timing(
