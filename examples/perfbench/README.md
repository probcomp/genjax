...
| `--is-repeats`, `--is-inner-repeats` | Forwarded to every IS timing helper (defaults: 100 / 100 for GenJAX, NumPyro, and handcoded JAX; Pyro falls back to 5 / 5 unless overridden). |
